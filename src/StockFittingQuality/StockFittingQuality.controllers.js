...
const sfqModel = require("./StockFittingQuality.models");
exports.Get_PPH_All = async (req, res) => {
  try {
    const erpTime = await sfqModel.getServerTime();
    //   console.log(erpTime)
    const type_Lean_Mapping_All = await sfqModel.Get_Type_Lean_Mapping_All();
